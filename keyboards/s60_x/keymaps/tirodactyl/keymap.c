...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	*/
    KEYMAP(
		...
		KC_FN0,  KC_LGUI, KC_LALT,            KC_SPACE,                   KC_RALT, KC_RGUI,  KC_APP,  KC_RCTL),
	...
	*/
    KEYMAP(
		...
		KC_TRNS, KC_TRNS, KC_PSCR, KC_FN1,  KC_FN2,  KC_FN3,  KC_CALC, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_LCTL, KC_TRNS, \
